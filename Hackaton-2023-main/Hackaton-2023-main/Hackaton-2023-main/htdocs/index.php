                    ...
                    <div class="col-md-7">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <a class="slider-btn1">
                              Indicateur global :  <a style="color:red" class="slider-btn1">Mauvais
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-7">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <a class="slider-btn1">
                              Indicateur global :  <a style="color:orange" class="slider-btn1">Moyen
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-7">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <p id="temperature-Colombes">Température : en attente de données...</p>
                          <p id="indicateur2-Colombes">Qualité de l'air (Colombes) : En attente de données...</p>
                          <div class="d-flex">
...
<script>
    ...
    var mapNanterre = L.map('map1').setView([48.89198, 2.20675], 13); // Coordonnées de Nanterre et niveau de zoom
...
<script>
    // Initialisation de la carte centrée sur Colombes
    var mapColombes = L.map('map2').setView([48.9226, 2.2530], 13); // Coordonnées d'Colombes et niveau de zoom
  ...
  <script>
    ...
    function getWeather() {
      ...
      // Colombes
      const latitudeColombes = 48.9226; // Latitude de Colombes
      const longitudeColombes = 2.2530; // Longitude de Colombes
      const apiUrlColombes = `https://api.openweathermap.org/data/2.5/weather?lat=${latitudeColombes}&lon=${longitudeColombes}&appid=${apiKey}&units=metric`;
      ...
      // Obtenez les données pour Colombes
      fetch(apiUrlColombes)
        .then(response => response.json())
        .then(data => {
          const temperatureColombes = data.main.temp;
          document.getElementById('temperature-Colombes').textContent = `Température à Colombes : ${temperatureColombes} °C`;
        })
        .catch(error => console.error('Erreur lors de la récupération des données météorologiques pour Colombes :', error));
    }
  ...
  <script>
    ...
    window.onload = function () {
      ...
      getAirQualityData('Colombes', 'indicateur2-Colombes');
    };
  </script>
